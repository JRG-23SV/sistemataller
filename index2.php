    ...
    <div class="content">
      <div class="container-fluid">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="<?php echo $URL?>/views/usuarios/usuarios2.php" class="small-box-footer">Mas detalles <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-purple">
              ...
              <a href="<?php echo $URL?>/views/clientes/clientes2.php" class="small-box-footer">Mas detalles <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
