...
<body class="hold-transition sidebar-mini">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a class="nav-link" href="<?php echo $URL; ?>/index2.php">INICIO</a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <div class="user-panel mt-3 pb-1 mb-1 d-flex">
            <div class="info">
              <h3><i class="nav-icon fas fa-user-alt"></i></h3>
            </div>
            <div class="info">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <center>
      <a href="<?php echo $URL; ?>/index2.php" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $URL ?>/views/usuarios/usuarios2.php" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $URL ?>/views/clientes/clientes2.php" class="nav-link ">
                  <i class="fa-solid fa-sheet-plastic nav-icon"></i>
                  <p>Listado de Clientes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo $URL ?>/views/clientes/crear2.php" class="nav-link">
