...
include('../../app/controllers/reparaciones/modificar_consulta.php');
                ...
                <div class="col-md-9">
                    <div class="card card-success" style="transition: all 0.15s ease 0s; height: inherit; width: inherit;">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="../../app/controllers/reparaciones/modificar_reparaciones.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-4">
