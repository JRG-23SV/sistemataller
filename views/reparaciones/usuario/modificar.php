...
include('../../../app/controllers/reparaciones/usuario/modificar_consulta.php');
include('../../../app/controllers/reparaciones/usuario/consulta_estado.php');
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">ACTUALIZANDO REPARACION</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div class="card card-success" style="transition: all 0.15s ease 0s; height: inherit; width: inherit;">
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="row">
                                ...
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-buscar_cliente">
                            ...
                            <div class="modal fade" id="modal-buscar_cliente">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #007E33;color: white">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="../../../app/controllers/reparaciones/usuario/modificar_reparaciones.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <input type="text" name="id_reparaciones" id="" value="<?php echo $idrep; ?>" hidden>
                                                    <input type="text" name="id_clientes" id="cliente_id" value="<?php echo $idclient; ?>" hidden>
                                                    <label for="">Cliente:</label>
                                                    <input type="text" nombre="cliente" class="form-control" id="cliente" value="<?php echo $nombre ?> <?php echo $apellido ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div style="display: flex">
                                                        <input type="text" nombre="marca" class="form-control" id="marca" value="<?php echo $marca ?>" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="modelo" id="modelo" class="form-control" value="<?php echo $modelo ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" nombre="placa" class="form-control" id="placa" value="<?php echo $placa ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="">Fecha:</label>
                                                    <input type="date" class="form-control" value="<?php echo $fecharep ?>" name="fecha">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="falla" cols="30" rows="3" class="form-control"><?php echo $fallarep ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
