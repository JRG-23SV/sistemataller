...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      ...
      <a href="crear.php" class="btn btn-primary"><h5>Agregar Usuario</h5></a>
      <hr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                        <div class="btn-group">
                          <a href="mostrar.php?id=<?php echo $usuarios_id; ?>" type="button" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                          <a href="modificar.php?id=<?php echo $usuarios_id; ?>" type="button" class="btn btn-success"><i class="fa fa-pencil-alt"></i> </a>
                          <a href="eliminar.php?id=<?php echo $usuarios_id; ?>" type="button" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </div>
                        </center>
                      </td>
                    </tr>
