...
?>
    ...
    <div class="content">
        ...
        <a href="crear2.php" class="btn btn-primary"><h5>Agregar Cliente</h5></a>
        <hr>
                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <div class="btn-group">
                                <a href="mostrar2.php?id=<?php echo $clientes_id; ?>" type="button" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                <a href="modificar2.php?id=<?php echo $clientes_id; ?>" type="button" class="btn btn-success"><i class="fa fa-pencil-alt"></i></a>
                            </center>
                        </td>
                    </tr>
