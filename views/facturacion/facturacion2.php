...
include('../../../app/controllers/facturacion/usuario/listado_facturacion.php');
                                            ...
                                            <div class="modal-dialog modal-s">
                                                <div class="modal-content modal-primary">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../../../app/controllers/facturacion/usuario/eliminar_facturacion.php" method="post">
