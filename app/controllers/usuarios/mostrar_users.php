...
$sql_usuarios = "SELECT usr.id_usuario as id_usuario, usr.username as username, usr.correo as correo, usr.fecha_creacion as fecha_creacion, rol.rol as rol 
...
foreach ($datos_usuarios as $dato_usuarios){
    ...
    $creacion = $dato_usuarios['fecha_creacion'];
}
